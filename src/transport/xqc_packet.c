...
/* parse a packet: first identify the packet type, wait until the tls key ready before packet paring if it's a long header. --carr001 */
static xqc_int_t /* modified by carr*/
